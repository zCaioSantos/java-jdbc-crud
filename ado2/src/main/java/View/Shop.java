...
public class Shop extends javax.swing.JFrame {
    ...
    private void btnSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSaveMouseClicked
        ...
        try {
            ...
            try {
                Computador pc = new Computador (hd, processador);
                ComputadorDAO.create(pc);
                this.dispose();
                JOptionPane.showMessageDialog(null, "Computador criado com sucesso!");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(null, "Erro ao tentar criar o computador!");
            }
